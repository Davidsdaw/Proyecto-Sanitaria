document.addEventListener('DOMContentLoaded', function () {
    ...
    const nombreInput = document.getElementById('register_nombre');
    const apellidosInput = document.getElementById('register_apellidos');
    const centroInput = document.getElementById('register_centro');
    const emailInput = document.getElementById('register_email');
    const passwordInput = document.getElementById('register_password');
    const passwordRepeatInput = document.getElementById('register_password-repeat');
